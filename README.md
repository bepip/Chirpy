...
This repository contains my work and progress from the "Learn HTTP Servers in typescript" course offered by [boot.dev](https://www.boot.dev/courses/learn-http-servers-typescript). The course focuses on building a production-ready HTTP web server from scratch using typescript and express.
...
2. Build a production-style HTTP server in typescript
3. Use JSON, headers, and status codes to communicate with clients via a RESTful API
4. Learn what makes typescript a great language for building fast web servers
5. Use drizzle ORM to store and retrieve data from a Postgres database
